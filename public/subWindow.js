...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const tweet_1 = __webpack_require__(59);
	const user_1 = __webpack_require__(61);
	...
	const createTweetModel = () => {
	    return new tweet_1.TweetModel(templateDate('tweet-data'));
	};
	const createAccountModel = () => {
	    return new user_1.AdminAccountModel(templateDate('account-data'));
	};
	const app = () => {
	    ...
	    button.addEventListener('click', () => {
	        const text = document.forms['tweet'].elements['post'].value;
	        console.log(text);
	    });
	};
	app();
...
/***/ function(module, exports, __webpack_require__) {
	...
	const media_1 = __webpack_require__(60);
	const initialModel = {
	    created_at: "",
	    id: 0,
	    id_str: '',
	...
	class TweetModel extends immutable_1.Record(initialModel) {
	    retweeted() {
	    ...
	    getMedia() {
	        return this.extended_entities.media.map(media => new media_1.MediaModel(media));
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	class MediaModel extends immutable_1.Record(initialMedia) {
	    getUrl() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	class UserModel extends immutable_1.Record(UserDefaultProperty) {
	}
	exports.UserModel = UserModel;
	const AdminDefaultProperty = Object.assign({}, UserDefaultProperty, { timeLine: [] });
	class AdminAccountModel extends immutable_1.Record(AdminDefaultProperty) {
...
/******/ });
//# sourceMappingURL=subWindow.js.map